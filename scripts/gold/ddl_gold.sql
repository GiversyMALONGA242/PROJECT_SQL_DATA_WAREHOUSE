...
Objectif du script :
    ...
    La couche Gold représente les tables de dimension et de faits finales (schéma en étoile).

    Chaque vue effectue des transformations et combine les données de la couche Silver 
    pour produire un jeu de données propre, enrichi et prêt pour les métiers.
